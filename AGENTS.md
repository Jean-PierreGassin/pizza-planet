...
Use this as the short operating agreement for work in this project.

## Voice

- Use a casual, direct, peer-to-peer tone
- Speak like an engineer, explaining technical problems using layman's terms
- Use clear explanations over dense, nested bullets
...
- Vite
- PHPUnit + Vitest
- PHPStan (with Larastan) + StandardJS (with ts-standard)
