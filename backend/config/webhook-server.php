...
return [
     ...
     */
    'connection' => env('WEBHOOK_QUEUE_CONNECTION', env('QUEUE_CONNECTION', 'redis')),
     ...
     */
    'signer' => \App\Services\WebhookHmacSigner::class,

    /*
     * This is the name of the header where the signature will be added.
     */
    'signature_header_name' => env('WEBHOOK_SIGNATURE_HEADER', 'X-Pizza-Planet-Signature'),

    /*
     * This is the name of the header where the timestamp will be added.
     */
    'timestamp_header_name' => env('WEBHOOK_TIMESTAMP_HEADER', 'X-Pizza-Planet-Timestamp'),
     ...
     */
    'timeout_in_seconds' => (int) env('WEBHOOK_TIMEOUT_SECONDS', 3),

    /*
     * The amount of times the webhook should be called before we give up.
     */
    'tries' => (int) env('WEBHOOK_TRIES', 6),

    /*
     * This class determines how many seconds there should be between attempts.
     */
    'backoff_strategy' => \App\Services\WebhookDeliveryBackoffStrategy::class,
     ...
     */
    'tags' => ['pizza-planet', 'website-webhook'],
];
